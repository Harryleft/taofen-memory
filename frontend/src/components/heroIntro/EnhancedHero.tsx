...
import RelationshipPageBackdrop from '../relationships/RelationshipPageBackdrop.tsx';
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-white to-cream">
      ...
      <div className="absolute inset-0 opacity-5">
        <RelationshipPageBackdrop scrollY={scrollY} />
      </div>
      
      {/* Geometric Background Elements */}
      <div className="absolute inset-0">
        <div className="absolute top-20 left-20 w-32 h-32 bg-gradient-to-br from-gold/10 to-transparent rounded-full blur-xl" />
        <div className="absolute bottom-32 right-32 w-48 h-48 bg-gradient-to-tl from-heritage-blue/10 to-transparent rounded-full blur-2xl" />
        <div className="absolute top-1/2 left-1/4 w-24 h-24 bg-gradient-to-r from-sage-green/10 to-transparent rounded-full blur-lg" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="text-center mb-20">
          ...
          >
            {/* Subtitle */}
            <div className="mb-6">
              <span className="inline-block px-4 py-2 bg-gold/10 text-gold text-sm font-medium rounded-full border border-gold/20">
                中国现代新闻出版先驱
              </span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="relative z-10">
                <div className="w-16 h-16 bg-gradient-to-br from-gold/20 to-gold/10 rounded-2xl flex items-center justify-center mb-6 group-hover:from-gold/30 group-hover:to-gold/20 transition-all duration-300">
                  <Scroll className="text-gold group-hover:scale-110 transition-transform duration-300" size={24} />
                </div>
                <h3 className="text-2xl font-bold text-gray-800 mb-4 group-hover:text-gold transition-colors duration-300 font-serif">
                  人生大事
                </h3>
                <p className="text-gray-600 leading-relaxed mb-6 text-sm">
                  追溯邹韬奋先生的人生轨迹，感受一位文化先驱的成长历程与时代担当
                </p>
                <div className="flex items-center text-gold group-hover:text-gold/80 transition-colors duration-300">
            ...
            >
              ...
              <div className="relative z-10">
                <div className="w-16 h-16 bg-gradient-to-br from-heritage-blue/20 to-heritage-blue/10 rounded-2xl flex items-center justify-center mb-6 group-hover:from-heritage-blue/30 group-hover:to-heritage-blue/20 transition-all duration-300">
                  <BookOpen className="text-heritage-blue group-hover:scale-110 transition-transform duration-300" size={24} />
                </div>
                <h3 className="text-2xl font-bold text-gray-800 mb-4 group-hover:text-heritage-blue transition-colors duration-300 font-serif">
                  生活书店
                </h3>
                <p className="text-gray-600 leading-relaxed mb-6 text-sm">
                  探索生活书店的发展历程，了解进步出版事业的光辉足迹
                </p>
                <div className="flex items-center text-heritage-blue group-hover:text-heritage-blue/80 transition-colors duration-300">
            ...
            >
              ...
              <div className="relative z-10">
                <div className="w-16 h-16 bg-gradient-to-br from-sage-green/20 to-sage-green/10 rounded-2xl flex items-center justify-center mb-6 group-hover:from-sage-green/30 group-hover:to-sage-green/20 transition-all duration-300">
                  <FileText className="text-sage-green group-hover:scale-110 transition-transform duration-300" size={24} />
                </div>
                <h3 className="text-2xl font-bold text-gray-800 mb-4 group-hover:text-sage-green transition-colors duration-300 font-serif">
                  韬奋手迹
                </h3>
                <p className="text-gray-600 leading-relaxed mb-6 text-sm">
                  欣赏邹韬奋先生的珍贵手稿，感受文字背后的思想力量
                </p>
                <div className="flex items-center text-sage-green group-hover:text-sage-green/80 transition-colors duration-300">
            ...
            >
              ...
              <div className="relative z-10">
                <div className="w-16 h-16 bg-gradient-to-br from-warm-rose/20 to-warm-rose/10 rounded-2xl flex items-center justify-center mb-6 group-hover:from-warm-rose/30 group-hover:to-warm-rose/20 transition-all duration-300">
                  <Users className="text-warm-rose group-hover:scale-110 transition-transform duration-300" size={24} />
                </div>
                <h3 className="text-2xl font-bold text-gray-800 mb-4 group-hover:text-warm-rose transition-colors duration-300 font-serif">
                  人脉网络
                </h3>
                <p className="text-gray-600 leading-relaxed mb-6 text-sm">
                  探索邹韬奋先生的社会关系网络，了解他与各界人士的深厚情谊
                </p>
                <div className="flex items-center text-warm-rose group-hover:text-warm-rose/80 transition-colors duration-300">
