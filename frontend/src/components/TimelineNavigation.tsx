    ...
    >
      <div className="flex flex-col items-center">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={scrollToTop}
          className="w-10 h-10 rounded-full border-2 border-[var(--timeline-text-muted)] bg-white flex items-center justify-center mb-4 hover:border-[var(--timeline-secondary)] hover:bg-[var(--timeline-secondary)] hover:text-white transition-all duration-200 group"
          style={{ boxShadow: "var(--timeline-card-shadow)" }}
        >
          <svg
            width="14"
            height="14"
            ...
            stroke="currentColor"
            strokeWidth="2.5"
            className="text-[var(--timeline-text-muted)] group-hover:text-white"
          >
        ...
        <div className="relative">
          ...
          <div className="relative space-y-8">
            {events.map((event, index) => {
              const isActive =
                activeEventId === event.year.toString();
              ...
              return (
                ...
                >
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={() =>
                      scrollToEvent(event.year.toString())
                    }
        ...
        <motion.button
          ...
          className="w-10 h-10 rounded-full border-2 border-[var(--timeline-text-muted)] bg-white flex items-center justify-center mt-4 hover:border-[var(--timeline-secondary)] hover:bg-[var(--timeline-secondary)] hover:text-white transition-all duration-200 group"
          style={{ boxShadow: "var(--timeline-card-shadow)" }}
        >
          <svg
            width="14"
        ...
        >
          <div
            style={{
              fontSize: "calc(var(--text-caption) * 0.75)",
